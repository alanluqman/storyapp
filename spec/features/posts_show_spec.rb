...
RSpec.describe 'renders post index Page', type: :feature do
  before(:example) do
    ...
    @subject2 = User.create(name: 'Alex', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from USA.', post_counter: 0)
    @post = Post.create(author: @subject1, title: 'Hello', text: 'This is my first post', comments_counter: 0, likes_counter: 0)
